...
import com.user.ums.util.ExceptionHandlerClass;
...
public class UserController {
	...
	@Operation(description = "Add User - "
			...
			responses = {
					...
					@ApiResponse(responseCode = "400", description = "failed to add user", content = {
							@Content(schema = @Schema(implementation = ExceptionHandlerClass.class, 
	...
	public ResponseEntity<ResponseStructure<UserResponse>> updateUser(@RequestBody @Valid UserRequest userRequest,@PathVariable int userId) {
